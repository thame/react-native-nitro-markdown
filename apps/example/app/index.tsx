...
export default function BenchmarkScreen() {
  ...
  const runBenchmark = () => {
    ...
    requestAnimationFrame(async () => {
      ...
      try {
        // Test data info
        results.push(`📊 Testing ${(REPEATED_MARKDOWN.length / 1024).toFixed(1)}KB of complex markdown`);
        results.push('');
        ...
        const markdownItParser = new (MarkdownIt as any)();
      ...
      <ScrollView style={styles.resultsScroll}>
        {error ? (
          ...
          <Text style={styles.instructionText}>
            Tap "Run Ultimate Benchmark" to compare Nitro (C++) against the top 3 JavaScript markdown parsers!
          </Text>
        )}
      </ScrollView>
    </View>
